    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(mvc.pattern("/divehub/products/getProduct/{id}")).permitAll()
                        .requestMatchers(mvc.pattern("/divehub/products/tag/{tag}")).permitAll()
                        .requestMatchers(mvc.pattern("/divehub/products/name/{name}")).permitAll()
                        .requestMatchers(mvc.pattern("/divehub/products/price/descending")).permitAll()
                        .requestMatchers(mvc.pattern("/divehub/products/price/ascending")).permitAll()
