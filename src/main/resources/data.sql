...
INSERT INTO activity (id, level_required, time_starts, time_ends, available_spaces, available) VALUES
    ...
    (3, 2, '2024-03-21 10:00:00', '2024-03-21 12:00:00', 10, true),
    (4, 1, '2024-03-21 10:00:00', '2024-03-21 12:00:00', 0, false),
    (6, 2, '2024-03-21 10:00:00', '2024-03-21 12:00:00', 7, true),
    (7, 0, '2024-03-21 10:00:00', '2024-03-21 12:00:00', 2, true),
    (9, 0, '2024-03-21 10:00:00', '2024-03-21 12:00:00', 9, true),
    (11, 1, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (12, 1, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (13, 2, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 0, false),
    (15, 0, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (17, 0, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (19, 1, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 0, false),
    (20, 1, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (22, 0, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (26, 0, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (27, 2, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true),
    (29, 1, '2024-03-22 14:00:00', '2024-03-22 16:00:00', 10, true);
...
VALUES
    ('a', '¡Hola! Espero que estés teniendo un excelente día. Recuerda tomarte un momento para relajarte y disfrutar de las pequeñas cosas. La vida está llena de sorpresas maravillosas. ¡Sonríe y sigue adelante con determinación!', NOW()-100),
...
VALUES
    (1, 'Una experiencia de buceo realmente emocionante, lo recomiendo altamente', 5, NOW()-100, 1),
    (1, 'Una experiencia de buceo realmente emocionante 2, lo recomiendo altamente', 2, NOW()-111, 1),
    (1, 'Una experiencia de buceo realmente emocionante 3, lo recomiendo altamente', 0, NOW()-120, 1),
    (1, 'Me encanta este kit de snorkel, es perfecto para explorar los arrecifes', 4, NOW()-121, 2),
    (1, 'El curso de buceo avanzado me ayudó a mejorar mis habilidades, excelente instructor', 4.5, NOW()-212, 3),
    (1, 'La excursión a la barrera de coral fue increíble, vi muchas especies marinas', 5, NOW()-321, 4),
    (1, 'Este traje de neopreno es cómodo y mantiene el calor, ideal para aguas frías', 4.5, NOW()-231, 5),
    (1, 'El curso de buceo básico fue una gran introducción al mundo del buceo, muy recomendado', 4, NOW()-444, 6),
    (1, 'El paquete de fotografía submarina tiene todo lo que necesito para capturar imágenes increíbles', 4.5, NOW()-111, 7),
    (1, 'Los accesorios de buceo son de alta calidad y útiles, definitivamente los volvería a comprar', 4, NOW()-421, 8),
    (1, 'El tour nocturno de buceo fue una experiencia única, la vida marina nocturna es fascinante', 5, NOW()-612, 9),
    (1, 'Las botellas de oxígeno son imprescindibles para bucear de forma segura, muy satisfecho con la compra', 4.5, NOW()-211, 10),
    (1, 'El curso de rescate acuático me proporcionó habilidades importantes para situaciones de emergencia', 4, NOW()-666, 11),
